...
add_binds("normal", {
    ...
    key({},          "space",       function (w) w:scroll{ y = "+0.95p"} end),
    key({"Shift"},   "space",       function (w) w:scroll{ y = "-0.95p"} end),
...
--    but({},          5, function (w, m) w:scroll_vert(more) end),
    ...
    key({"Control"}, "h",           function (w, c) w:enter_cmd(":history ")    end),
...
add_cmds({
 ...
 -- cmd("co[mmand]",            function (w, arg, opts) .. end, opts),
    ...
    cmd({"scribe",      "scr"}, function (w) w:eval_js("gsblet=window.gsblet||{};if(!gsblet.toggle)(function(){var t=gsblet,d=document,o=d.body,c='createElement',a='appendChild',p=window.location.protocol;t['b']='googlescribe.appspot.com';t['l']='en';t.toggle=function(o){t['o']=o};x=o[a](d[c]('script'));x.id='gsbletloader';x.src=(p=='https:'?'https:':'http:')+'//'+t['b']+'/jsres/rgsblet.js?v='+(new Date().getTime());})();gsblet.toggle(false)") end), 
